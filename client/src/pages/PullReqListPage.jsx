            ...
            <div className='w-full px-[1rem] md:px-[2rem] lg:px-[5rem] py-6 mt-16'>
                <div className='w-full md:w-[75%] mx-auto py-4'>
                    <span className='flex items-center justify-between'>
                        ...
                        <Link to="/repository/id/createPullReq" className='py-1 md:py-2 px-2 md:px-3 text-sm md:text-sm font-medium text-white bg-[#1c6823] rounded-lg border border-[#1c6823] hover:opacity-85 focus:ring-4 focus:outline-none  dark:bg-gray-300 dark:hover:bg-gray-400 dark:focus:ring-gray-300'>New pull request</Link>
                    </span>
