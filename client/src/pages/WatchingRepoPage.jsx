...
import { WatchingRepositoryListRequest } from '../apiRequests/repositoryRequest'

const WatchingRepoPage = () => {
    ...
    useEffect(() => {
        const search = setTimeout(() => {
            (async () => {
                await WatchingRepositoryListRequest(pageNo + 1, perPage, searchKey, sort)
            })();
        }, 1000);
...
export default WatchingRepoPage
