  ...
  return (
    <AppWrapper>
      <div className='w-[100vw] px-[1rem] md:px-[2rem] lg:px-[5rem] py-6 mt-16'>
        <div className="mx-auto px-4 pb-6 w-[80%] sm:w-[60%] text-center lg:pb-8 xl:pb-11.5">
          <div className="mx-auto -z-[1] relative drop-shadow-2 sm:w-[200px] sm:h-[200px] md:w-[250px] md:h-[250px] rounded-full object-fill">
            <img className='h-full w-full' src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=250&h=250&q=80" alt="profile" />
            <label
              htmlFor="profile"
              className="absolute bottom-2 z-10 right-2 flex h-8.5 w-8.5 cursor-pointer items-center justify-center rounded-full p-1 bg-black"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="1rem" height="1rem" viewBox="0 0 24 24" fill="white" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-camera"><path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z" /><circle cx="12" cy="13" r="3" /></svg>
              <input
                type="file"
                name="profile"
                id="profile"
          ...
          <div className="mt-4">
            ...
            <div className="mx-auto max-w-180">
              ...
              <p className="mt-4.5 w-full sm:w-[70%] text-center mx-auto">
